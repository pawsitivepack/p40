        ...
        <div className="w-full py-8 md:py-12 px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[20%_60%_20%] gap-6 pr-4 lg:pr-8">
                    ...
                    <Link key={dog._id} to={`/dog/${dog._id}`}>
                      ...
                      >
                        <div className="h-40 bg-gray-200 relative">
                          ...
                          <img
                            src={dog.imageURL || "/placeholder.svg?height=160&width=240" || "/placeholder.svg"}
                            alt={dog.name}
                            className="w-full h-full object-cover"
                          />
                        </div>
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Adopt</h3>
                    <p className="text-gray-600 text-sm">Provide a permanent loving home for a dog in need.</p>
                    <Link
                      to="/adoption-board"
                      className="mt-3 inline-block text-[#8c1d35] font-medium text-sm hover:underline"
                    >
            ...
            <div className="hidden lg:block space-y-6 transition-all duration-300 lg:sticky top-[70px] self-start">
              {role !== "" && <UpcomingWalksSection />}
              {role !== "" && <PastWalksSection />}
              {role !== "" && <NotificationsSection />}
            </div>
