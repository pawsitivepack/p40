...
export default function Home() {
  ...
  const getRandomDogIndex = () => {
    ...
    } while (previousIndices.includes(newIndex) && previousIndices.length < featuredDogs.length - 1)
  ...
  const QuickLinksSection = () => (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        {role === "user" && (
          <>
            {renderLink("/marshal-application", <FaUserShield />, "Apply for Marshal")}
            {renderLink("/adoption-board", <FaPaw />, "Adoption Board")}
          ...
          <div className="space-y-4">
            {walks.slice(0, 3).map((walk) => (
              <motion.div
                ...
                whileHover={{ y: -2, boxShadow: "0 5px 15px -3px rgba(0, 0, 0, 0.1)" }}
              >
                <div className="flex items-center justify-between">
                  <p className="font-semibold text-[#8c1d35]">{formatDate(walk.date)}</p>
            ...
            <Link to="/mywalks" className="text-[#8c1d35] text-sm font-medium flex items-center hover:underline">
      ...
      <div className="p-5">
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <Link to="/walk-history" className="text-[#8c1d35] text-sm font-medium flex items-center hover:underline">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 border border-gray-100 mb-6 relative">
            <div className="overflow-hidden rounded-xl relative h-[80vh] min-h-[400px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <img
                    src={featuredDogs.length > 0 ? featuredDogs[currentDogIndex]?.imageURL : "/placeholder.svg"}
                    alt={
                      featuredDogs.length > 0 ? `Featured Dog: ${featuredDogs[currentDogIndex]?.name}` : "Featured Dog"
                    }
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between">
                  <div className="text-center sm:text-left mb-4 sm:mb-0">
                    ...
                    <p className="text-[#f8d3a9] opacity-90 text-sm sm:text-base max-w-full sm:max-w-md overflow-hidden text-ellipsis">
                      We're dedicated to providing care and finding homes for dogs in need. Join us in making a
                      difference.
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[20%_60%_20%] gap-6 pr-4 lg:pr-8">
            ...
            >
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Dog Care</h3>
                    <p className="text-gray-600">
                      We provide shelter, food, medical care, and love to dogs in need until they find their forever
                      homes.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Community Support</h3>
                    <p className="text-gray-600">
                      Our volunteers and supporters make our mission possible through donations, walks, and advocacy.
                    </p>
                  </motion.div>
                </div>
              </motion.div>
                    ...
                    <Link key={dog._id} to={`/dog/${dog._id}`}>
                      ...
                      >
                        <div className="h-40 bg-gray-200 relative">
                          ...
                          <img
                            src={dog.imageURL || "/placeholder.svg?height=160&width=240"}
                            alt={dog.name}
                            className="w-full h-full object-cover"
                          />
                        </div>
                        <div className="p-4">
                          <h3 className="font-bold text-[#8c1d35]">{dog.name}</h3>
              ...
              >
                ...
                >
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="w-full md:w-2/3">
                      <h3 className="text-lg font-semibold text-[#8c1d35] mb-1">Rocky Found His Forever Home</h3>
                      <p className="text-sm text-gray-500 mb-2">Adopted March 2023</p>
                      <p className="text-gray-600">
                        After 6 months at our shelter, Rocky was adopted by the Johnson family. He now enjoys long hikes
                        and has become best friends with their 7-year-old son.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="w-full md:w-2/3">
                      <h3 className="text-lg font-semibold text-[#8c1d35] mb-1">Daisy's Second Chance</h3>
                      <p className="text-sm text-gray-500 mb-2">Adopted January 2023</p>
                      <p className="text-gray-600">
                        Rescued from a difficult situation, Daisy has blossomed in her new home. Her new family reports
                        she loves car rides and has become the neighborhood's favorite dog.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-[#8c1d35]">
                    <FaHandHoldingHeart className="inline mr-2" /> How You Can Help
                  </h2>
                  <div className="h-1 flex-grow ml-4 bg-gradient-to-r from-[#e8d3a9] to-transparent rounded-full"></div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Volunteer</h3>
                    <p className="text-gray-600 text-sm">
                      Walk dogs, help with events, or assist with administrative tasks.
                    </p>
                    <Link
                      to="/volunteer"
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Donate</h3>
                    <p className="text-gray-600 text-sm">
                      Support our mission with financial contributions or supplies from our wishlist.
                    </p>
                    <Link to="/donate" className="mt-3 inline-block text-[#8c1d35] font-medium text-sm hover:underline">
                      Donate now →
                    </Link>
                  </motion.div>
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-2">Foster</h3>
                    <p className="text-gray-600 text-sm">Provide a temporary home for a dog waiting for adoption.</p>
                    <Link to="/foster" className="mt-3 inline-block text-[#8c1d35] font-medium text-sm hover:underline">
                      Apply now →
                    </Link>
                  </motion.div>
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-[#8c1d35]">🤝 Our Partners</h2>
                  <div className="h-1 flex-grow ml-4 bg-gradient-to-r from-[#e8d3a9] to-transparent rounded-full"></div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
                  >
                    <img src="/partner1.png" alt="Partner 1" className="w-20 h-20 mx-auto mb-4 object-contain" />
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-1">Happy Tails Vet</h3>
                    <p className="text-sm text-gray-600">
                      Providing regular checkups, vaccinations, and medical care to our dogs.
                    </p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
                  >
                    <img src="/partner2.png" alt="Partner 2" className="w-20 h-20 mx-auto mb-4 object-contain" />
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-1">PetCo Foundation</h3>
                    <p className="text-sm text-gray-600">
                      Supporting our shelter through generous donations and supplies.
                    </p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
                  >
                    <img src="/partner3.png" alt="Partner 3" className="w-20 h-20 mx-auto mb-4 object-contain" />
                    <h3 className="text-lg font-semibold text-[#8c1d35] mb-1">ULM Students United</h3>
                    <p className="text-sm text-gray-600">
                      Volunteers and event support from students passionate about animal care.
                    </p>
                  </motion.div>
                </div>
              </motion.div>
