import { CameraIcon, EnvelopeIcon, GlobeAltIcon, MapPinIcon, PhoneIcon, PlayIcon } from "@heroicons/react/24/solid";
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div>
                ...
                <li><a href="/walkdogs" className="hover:underline">Walk Dogs</a></li>
              ...
              <div>
                ...
                <ul className="font-medium space-y-3">
                  <li className="flex items-start justify-center">
                    <MapPinIcon className="w-6 h-6 text-red-500 mr-2 mt-1" />  {/* Icon aligned with the first line */}
                    <div>
                  ...
                  <li className="flex items-center justify-center">
                    ...
                    <a href="mailto:contact@p40dogs.com" className="hover:underline">contact@p40dogs.com</a>
                  </li>
                  <li className="flex items-center justify-center">
            ...
            <div>
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://facebook.com" className="bg-purple-700 p-2 rounded-full hover:bg-purple-500">
                  <GlobeAltIcon className="text-white w-5 h-5" />
                </a>
                <a href="https://instagram.com" className="bg-purple-700 p-2 rounded-full hover:bg-purple-500">
                  <CameraIcon className="text-white w-5 h-5" />
                </a>
                <a href="https://tiktok.com" className="bg-purple-700 p-2 rounded-full hover:bg-purple-500">
          ...
          <div className="flex justify-center items-center text-center">
            <span className="text-sm">
              © 2025 <a href="/" className="hover:underline">P-40 Dogs™</a>. All Rights Reserved.
            </span>
